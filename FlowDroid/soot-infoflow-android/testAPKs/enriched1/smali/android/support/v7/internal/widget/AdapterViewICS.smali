...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 126
    iput-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mInLayout:Z
    ...
    .line 225
    iput-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mBlockLayoutRequests:Z
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 67
    iput p3, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mFirstPosition:I
    ...
    .line 152
    iput v0, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mNextSelectedPosition:I
    ...
    .line 163
    iput v0, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectedPosition:I
...
.method private fireOnSelected()V
    ...
    .line 891
    iget-object v6, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mOnItemSelectedListener:Landroid/support/v7/internal/widget/AdapterViewICS$OnItemSelectedListener;
    ...
    invoke-interface {v6, p0}, Landroid/support/v7/internal/widget/AdapterViewICS$OnItemSelectedListener;->onNothingSelected(Landroid/support/v7/internal/widget/AdapterViewICS;)V
...
.method private updateEmptyStatus(Z)V
    ...
    .line 738
    iget-object v7, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mEmptyView:Landroid/view/View;
    ...
    .line 740
    invoke-virtual {p0, v9}, Landroid/support/v7/internal/widget/AdapterViewICS;->setVisibility(I)V

    .line 749
    :goto_0
    iget-boolean v6, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mDataChanged:Z
    ...
    .line 743
    invoke-virtual {p0, v8}, Landroid/support/v7/internal/widget/AdapterViewICS;->setVisibility(I)V
...
.method protected canAnimate()Z
    ...
    iget v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mItemCount:I
...
.method checkFocus()V
    ...
    iget-boolean v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mDesiredFocusableInTouchModeState:Z
    ...
    iget-boolean v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mDesiredFocusableState:Z
    ...
    .line 722
    iget-object v5, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mEmptyView:Landroid/view/View;
...
.method checkSelectionChanged()V
    ...
    iget-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectedRowId:J

    iget-wide v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mOldSelectedRowId:J
...
.method findSyncPosition()I
    ...
    iget v1, v0, Landroid/support/v7/internal/widget/AdapterViewICS;->mItemCount:I
    ...
    iget-wide v3, v0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncRowId:J

    move-object/from16 v0, p0

    iget v2, v0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncPosition:I
    ...
    .line 1044
    invoke-interface {v14, v2}, Landroid/widget/Adapter;->getItemId(I)J
...
.method public getPositionForView(Landroid/view/View;)I
    ...
    .line 618
    invoke-virtual {p0, v7}, Landroid/support/v7/internal/widget/AdapterViewICS;->getChildAt(I)Landroid/view/View;
    ...
    .line 619
    iget v6, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mFirstPosition:I
...
.method handleDataChanged()V
    ...
    .line 928
    iget-boolean v2, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mNeedSync:Z
    ...
    .line 931
    iput-boolean v3, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mNeedSync:Z
    ...
    .line 938
    invoke-virtual {p0, v4, v3}, Landroid/support/v7/internal/widget/AdapterViewICS;->lookForSelectablePosition(IZ)I
    ...
    .line 941
    invoke-virtual {p0, v4}, Landroid/support/v7/internal/widget/AdapterViewICS;->setNextSelectedPositionInt(I)V
    ...
    .line 959
    invoke-virtual {p0, v5, v3}, Landroid/support/v7/internal/widget/AdapterViewICS;->lookForSelectablePosition(IZ)I
...
.method protected onLayout(ZIIII)V
    ...
    iput p5, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mLayoutHeight:I
...
.method public performItemClick(Landroid/view/View;IJ)Z
    ...
    .line 303
    iget-object v7, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mOnItemClickListener:Landroid/support/v7/internal/widget/AdapterViewICS$OnItemClickListener;
    ...
    .line 304
    invoke-virtual {p0, v8}, Landroid/support/v7/internal/widget/AdapterViewICS;->playSoundEffect(I)V
...
.method rememberSyncState()V
    ...
    .line 1124
    iget v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectedPosition:I
    ...
    .line 1126
    iget v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mNextSelectedPosition:I

    iput v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncPosition:I
    ...
    iput v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSpecificTop:I
    ...
    .line 1130
    iput v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncMode:I
    ...
    .line 1133
    invoke-virtual {p0, v1}, Landroid/support/v7/internal/widget/AdapterViewICS;->getChildAt(I)Landroid/view/View;
    ...
    .line 1135
    iget v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mFirstPosition:I
    ...
    iput-wide v8, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncRowId:J
...
.method selectionChanged()V
    ...
    .line 870
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mInLayout:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mBlockLayoutRequests:Z

    if-eqz v1, :cond_4

    .line 875
    :cond_0
    iget-object v2, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectionNotifier:Landroid/support/v7/internal/widget/AdapterViewICS$SelectionNotifier;

    if-nez v2, :cond_1

    .line 876
    new-instance v2, Landroid/support/v7/internal/widget/AdapterViewICS$SelectionNotifier;

    .line 876
    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Landroid/support/v7/internal/widget/AdapterViewICS$SelectionNotifier;-><init>(Landroid/support/v7/internal/widget/AdapterViewICS;Landroid/support/v7/internal/widget/AdapterViewICS$1;)V

    iput-object v2, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectionNotifier:Landroid/support/v7/internal/widget/AdapterViewICS$SelectionNotifier;

    .line 878
    :cond_1
    iget-object v2, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSelectionNotifier:Landroid/support/v7/internal/widget/AdapterViewICS$SelectionNotifier;

    invoke-virtual {p0, v2}, Landroid/support/v7/internal/widget/AdapterViewICS;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v7/internal/widget/AdapterViewICS;->sendAccessibilityEvent(I)V
...
.method public setFocusable(Z)V
    ...
    .line 694
    iput-boolean v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mDesiredFocusableInTouchModeState:Z
...
.method public setFocusableInTouchMode(Z)V
    ...
    .line 707
    iput-boolean v4, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mDesiredFocusableState:Z
...
.method setNextSelectedPositionInt(I)V
    ...
    iget v3, p0, Landroid/support/v7/internal/widget/AdapterViewICS;->mSyncMode:I
...
.method public setOnItemLongClickListener(Landroid/support/v7/internal/widget/AdapterViewICS$OnItemLongClickListener;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/internal/widget/AdapterViewICS;->setLongClickable(Z)V
