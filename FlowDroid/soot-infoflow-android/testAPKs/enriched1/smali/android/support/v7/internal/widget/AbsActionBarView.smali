...
.method public animateToVisibility(I)V
    ...
    .line 125
    invoke-virtual {p0, v2}, Landroid/support/v7/internal/widget/AbsActionBarView;->startAnimation(Landroid/view/animation/Animation;)V

    .line 126
    invoke-virtual {p0, p1}, Landroid/support/v7/internal/widget/AbsActionBarView;->setVisibility(I)V

    .line 128
    iget-object v3, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->mSplitView:Landroid/support/v7/internal/widget/ActionBarContainer;

    if-eqz v3, :cond_0

    iget-object v4, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->mMenuView:Landroid/support/v7/internal/view/menu/ActionMenuView;
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/internal/view/menu/ActionMenuView;->startAnimation(Landroid/view/animation/Animation;)V

    .line 130
    iget-object v4, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->mMenuView:Landroid/support/v7/internal/view/menu/ActionMenuView;

    invoke-virtual {v4, p1}, Landroid/support/v7/internal/view/menu/ActionMenuView;->setVisibility(I)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v4, v1, v6}, Landroid/content/res/TypedArray;->getLayoutDimension(II)I
    ...
    .line 71
    iget-boolean v7, p0, Landroid/support/v7/internal/widget/AbsActionBarView;->mSplitWhenNarrow:Z
    ...
    sget v0, Landroid/support/v7/appcompat/R$bool;->abc_split_action_bar_is_narrow:I

    invoke-virtual {v8, v0}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v7

    invoke-virtual {p0, v7}, Landroid/support/v7/internal/widget/AbsActionBarView;->setSplitActionBar(Z)V
    ...
    invoke-virtual {v9, p1}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected positionChild(Landroid/view/View;III)I
    ...
    invoke-virtual {p1, p2, p4, p3, v2}, Landroid/view/View;->layout(IIII)V
...
.method protected positionChildInverse(Landroid/view/View;III)I
    ...
    invoke-virtual {p1, p3, p4, p2, v2}, Landroid/view/View;->layout(IIII)V
