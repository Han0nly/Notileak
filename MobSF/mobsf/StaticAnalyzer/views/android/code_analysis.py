...
def code_analysis(app_dir, typ, manifest_file):
    ...
    try:
        ...
        ######### Xiaohan modified here!!!!
        permission_rules = root / 'android' / 'rules' / 'permission_apis.yaml'
        ########
        code_findings = {}
        api_findings = {}
        email_n_file = []
        ...
        permission_findings = scan(
            permission_rules.as_posix(),
            {'.java', '.kt'},
            [src],
            skp)
        # code_findings = scan(
        ...
        #     manifest_file,
        #     None)
        logger.info('Skipping NIAP Analyzer')
        ...
        code_an_dic = {
            # change api_findings to permission_findings
            'api': permission_findings,
